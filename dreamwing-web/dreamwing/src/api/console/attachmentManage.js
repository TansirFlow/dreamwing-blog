...
export const getMyAttachmentListByConditionService = (searchCondition) => {
    ...
    return request.post(`/attachment/list/admin`, JSON.stringify(searchCondition.value), { headers: { 'content-type': "application/json" } })
}

export const deleteAttachmentServive = (id) => {
    return request.post(`/attachment/delete/admin/${id}`)
}

export const deleteAttachmentByIdListService = (idList) => {
    return request.post(`/attachment/delete/list/admin`, JSON.stringify(idList), { headers: { 'content-type': "application/json" } })
}
