...
import { getMyAttachmentListByConditionService, deleteAttachmentServive, deleteAttachmentByIdListService, getAttachmentTypeListService,uploadFileService } from '@/api/console/attachmentManage'
