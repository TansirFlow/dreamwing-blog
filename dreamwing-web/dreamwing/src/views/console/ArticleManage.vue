...
import { getMyArticleListService, getMyArticleListByConditionService, deleteArticleServive,deleteArticleByIdListService } from '@/api/console/articleManage'
...
const handleClickArticleToEdit = (id) => {
    router.push(`/console/editArticle/${id}`)
}
